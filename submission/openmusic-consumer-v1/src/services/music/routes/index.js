...
import { createAlbumPayload, updateAlbumPayload, createSongsPayload, updateSongsPayload } from '../validator/schema.js';
...
router.get('/albums/:id/likes', getLikeAlbum);
router.delete('/albums/:id/likes', authenticateToken, unlikeAlbum);
